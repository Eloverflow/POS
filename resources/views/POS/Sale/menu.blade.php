...
<div id="sidebar-collapse" class="col-sm-3 col-lg-5 sidebar">
    ...
    <div class="div-bill-total">
        ...
        <button ng-show="commandItemTimeToggle" href="#" ng-click="toggleCommandTime()"  style="background-color: #8ad919" type="button" class="btn btn-success"><span class="glyphicon glyphicon-euro"></span>
            Afficher le montant
        </button>
        <button ng-hide="commandItemTimeToggle" href="#" ng-click="toggleCommandTime()"   type="button" class="btn btn-success"><span class="glyphicon glyphicon-time"></span>
            Afficher le temps
        </button>
    ...
    <div class="div-btn-facture">
        ...
        <button ng-click="" type="button" class="btn btn-success btn-facture">Diviser Factures</button>
    </div>
